...
% Concurrence_9_6(length(chi),1:length(phi)) = 0;
% Concurrence_2_4(length(chi),1:length(phi)) = 0;
% Concurrence_1_2(length(chi),1:length(phi)) = 0;
Concurrence_3_6(length(chi),1:length(phi)) = 0;
...
%          Concurrence_9_6(cnt_chi,counter) =   Con_Nm3_N;
%          
...
%           
          Con_3_6 = red_density_matrix_3_6(Psi,N) ;
          Concurrence_3_6(cnt_chi,counter) =  Con_3_6;
       end
...
% 
% figure
% contourf(phi,chi,Concurrence_9_6)
% xlabel('\phi')
% ylabel('\chi')
% title('C_{96}')
% colormap jet
...
figure
contourf(phi,chi,Concurrence_3_6)
xlabel('\phi')
ylabel('\chi')
title('C_{36}')
colormap jet
